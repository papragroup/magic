...
export const SubCategoryDeleteDialog = (props: ISubCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="magicBodyApp.subCategory.delete.question">
        <Translate contentKey="magicBodyApp.subCategory.delete.question" interpolate={{ id: subCategoryEntity.id }}>
